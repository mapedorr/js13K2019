...
gulp.task('watch', (done) => {
	gulp.watch('./src/js/**/*.js', gulp.series('concat-libs', 'build-js', 'concat-all', 'zip', 'check'));
...
gulp.task('build-js', (done) => {
	...
	.pipe(concat('mine.js'))
	// .pipe(uglify())
	.pipe(gulp.dest('./src/pre/'));
});

gulp.task('concat-libs', (done) => {
	return gulp.src('./src/lib/**/*.js')
	.pipe(concat('libs.js'))
	.pipe(gulp.dest('./src/pre/'));
});

gulp.task('concat-all', (done) => {
	return gulp.src('./src/pre/**/*.js')
	.pipe(concat('game.js'))
...
gulp.task('build', gulp.series('build-html', 'concat-libs', 'build-js', 'concat-all', 'build-assets', 'check', (done) => {
	done();
}));